import mil_nets.pooling_method as pooling
...
class Feature_pooling(Layer):
    def __init__(self, output_dim, kernel_initializer='glorot_uniform', bias_initializer='zeros',
                 kernel_regularizer=None, bias_regularizer='zeros', use_bias=True, pooling_mode='max', **kwargs):
    ...
    def build(self, input_shape):
        ...
        self.kernel = self.add_weight(shape=(input_dim, self.output_dim), initializer=self.kernel_initializer,
                                      name='kernel', regularizer=self.kernel_regularizer, trainable=True)
        if self.use_bias:
    ...
    def get_config(self):
        config = {
            ...
            'bias_regularizer': initializers.serialize(self.bias_regularizer),
